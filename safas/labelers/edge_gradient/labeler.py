...
params = {
    ...
    "children": 
    [	
        {"name": "thresh_inv", "title": "Inverse threshold", "type":  "bool", "value": True, "readOnly": True},
...
def labeler(src, 
    ...
    **kwargs
    ...
    if thresh_inv: # thresh_inv = True is brightfield, ie the objects are darker than the field
        ...
        ret, thresh = cv2.threshold(src, thresh_val, 0, cv2.THRESH_BINARY)
